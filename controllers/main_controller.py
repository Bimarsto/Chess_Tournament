import views.round
from views.menus import MainMenu, TournamentMenu, RoundMenu
...
class MainController:
        ...
        if menu_selection == "0":
            ...
            if len(active_tournament.tournament_players) == active_tournament.max_players:
                ...
                if len(active_tournament.tournament_rounds) < active_tournament.number_of_rounds:
                    ...
                    self.round(active_tournament.tournament_rounds[-1])
                else:
    ...
    def round(self, active_round):
        RoundView(active_round).display_round_matchs()
        round_selection = RoundMenu(active_round).round_menu()
